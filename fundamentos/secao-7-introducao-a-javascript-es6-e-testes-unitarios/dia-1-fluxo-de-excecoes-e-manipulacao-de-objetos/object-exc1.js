const order = {
  ...
  const orderModifier = (order) => {
    return console.log(`Olá ${order.name="Luiz Silva"}, o total do seu pedido de ${Object.keys(order.order.pizza)} e ${Object.values(order.order.drinks.coke.type).join("")} é ${order.payment.total = 50}`)
  };
